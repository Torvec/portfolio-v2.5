...
export default function ProjectDetails() {
  ...
  return (
    <>
      ...
      <ProjectsNav />
      <section className="grid grid-cols-1 bg-orange-500 p-5 gap-5 lg:grid-cols-2 lg:gap-10 lg:p-10">
        {/* PROJECT IMAGES */}
        ...
        {/* PROJECT DETAILS */}
        <div className="flex flex-col gap-5 border-2 border-stone-900 bg-stone-100 p-5 lg:p-10">
