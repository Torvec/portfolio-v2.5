...
export default function Footer() {
  ...
  return (
    <footer className="border-t-2 border-stone-200 flex flex-col md:flex-row items-center md:items-baseline md:justify-between gap-10 bg-stone-900 px-5 py-10 text-center font-sans md:ext-lg uppercase text-stone-200">
